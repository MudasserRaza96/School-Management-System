...
namespace SchoolApp.DAL.Migrations
{
    ...
    [Migration("20260903183402_first-project-running")]
    partial class firstprojectrunning
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolApp.Models.DataModels.Mark", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Feedback = "Good job!",
                            Grade = 1,
                            MarkEntryDate = new DateTime(2026, 9, 3, 23, 33, 55, 330, DateTimeKind.Local).AddTicks(7309),
                            ObtainedScore = 65,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 1,
                        ...
                        new
                        {
                            ...
                            Grade = 0,
                            MarkEntryDate = new DateTime(2026, 9, 3, 23, 33, 55, 330, DateTimeKind.Local).AddTicks(7317),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 2,
                        ...
                        new
                        {
                            ...
                            Feedback = "Excellent work!",
                            Grade = 0,
                            MarkEntryDate = new DateTime(2026, 9, 3, 23, 33, 55, 330, DateTimeKind.Local).AddTicks(7322),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 3,
